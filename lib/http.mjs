...
// NB: aplicația e strict same-origin (frontend + API pe același domeniu Vercel,
// apiFetch cu credentials:'same-origin', niciun endpoint nu setează
// Access-Control-Allow-Origin). Un helper `cors()` care reflecta `Origin` +
// `Allow-Credentials: true` a fost eliminat: era cod mort și un footgun
// (dacă ar fi fost cablat pe un endpoint cu cookie, orice site ar fi putut
// citi datele unui utilizator autentificat).
